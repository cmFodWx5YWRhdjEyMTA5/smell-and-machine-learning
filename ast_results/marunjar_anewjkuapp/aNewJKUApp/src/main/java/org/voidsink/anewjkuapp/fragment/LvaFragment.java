...
public class isClassOrIsInterface extends SlidingTabsFragment {
    ...
    protected void isMethod(List<SlidingTabItem> isParameter) {
        ...
        isNameExpr.isMethod(new TermTabItem(isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr), null, LvaDetailFragment.class));
        for (Term isVariable : isNameExpr) {
            isNameExpr.isMethod(new TermTabItem(isNameExpr.isMethod(), isNameExpr.isMethod(isNameExpr), LvaDetailFragment.class));
        }
    }
