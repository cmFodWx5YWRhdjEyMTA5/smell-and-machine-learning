...
public class isClassOrIsInterface extends Drawable {
    ...
    public isConstructor(Context isParameter) {
        ...
        // isComment
        // isComment
        float isVariable = isNameExpr.isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
    ...
    public void isMethod(@NonNull Canvas isParameter) {
        ...
        isNameExpr.isMethod(isNameExpr, isNameExpr.isFieldAccessExpr / isIntegerConstant, ((float) isNameExpr.isFieldAccessExpr + isNameExpr + isIntegerConstant) / isIntegerConstant, isNameExpr);
    }
