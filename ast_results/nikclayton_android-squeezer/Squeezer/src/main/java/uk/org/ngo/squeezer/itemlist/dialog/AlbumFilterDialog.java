...
public class isClassOrIsInterface extends BaseFilterDialog {

    private AlbumListActivity isVariable;
    ...
    public Dialog isMethod(Bundle isParameter) {
        ...
        isNameExpr = (AlbumListActivity) isMethod();
        isNameExpr = (EditText) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        isNameExpr.isMethod(isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr.isMethod().isMethod(isIntegerConstant)));
        isNameExpr.isMethod(isNameExpr.isMethod());
        isNameExpr = (Spinner) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        isNameExpr = (Spinner) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        new GenreSpinner(isNameExpr, isNameExpr, isNameExpr);
        new YearSpinner(isNameExpr, isNameExpr, isNameExpr);
        if (isNameExpr.isMethod() != null) {
            ((EditText) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr)).isMethod(isNameExpr.isMethod().isMethod());
    ...
    protected void isMethod() {
        ...
        isNameExpr.isMethod((Genre) isNameExpr.isMethod());
        isNameExpr.isMethod((Year) isNameExpr.isMethod());
        isNameExpr.isMethod();
    }
}
