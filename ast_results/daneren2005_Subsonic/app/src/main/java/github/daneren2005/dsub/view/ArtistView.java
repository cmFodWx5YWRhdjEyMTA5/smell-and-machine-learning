 ...
 * isComment
 */
public class isClassOrIsInterface extends UpdateView<Artist> {

    private static final String isVariable = ArtistView.class.isMethod();
    ...
    public isConstructor(Context isParameter) {
        super(isNameExpr);
        isNameExpr.isMethod(isNameExpr).isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, this, true);
    ...
    protected void isMethod(Artist isParameter) {
