...
public class isClassOrIsInterface {
    ...
    public void isMethod() {
        ...
        for (PropertyType isVariable : isNameExpr.isMethod()) {
            ...
            PropertyType isVariable = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, isNameExpr);
            isMethod(isNameExpr == isNameExpr);
        }
        // isComment
        PropertyType isVariable = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, "isStringConstant");
