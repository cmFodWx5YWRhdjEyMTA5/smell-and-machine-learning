...
public class isClassOrIsInterface extends EpActivity {
    ...
    private void isMethod() {
        Intent isVariable = new Intent(this, CalculatorList.class);
        isMethod(isNameExpr);
    }

    private void isMethod() {
        Intent isVariable = new Intent(this, DiagnosisList.class);
        isMethod(isNameExpr);
    }

    private void isMethod() {
        Intent isVariable = new Intent(this, RiskScoreList.class);
        isMethod(isNameExpr);
    }

    private void isMethod() {
        Intent isVariable = new Intent(this, ReferenceList.class);
        isMethod(isNameExpr);
    }
}
