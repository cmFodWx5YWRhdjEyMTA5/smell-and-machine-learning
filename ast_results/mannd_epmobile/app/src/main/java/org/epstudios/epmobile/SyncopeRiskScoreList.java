...
public class isClassOrIsInterface extends EpActivity {
    ...
    private void isMethod() {
        Intent isVariable = new Intent(this, SyncopeSfRule.class);
        isMethod(isNameExpr);
    }

    private void isMethod() {
        Intent isVariable = new Intent(this, MartinAlgorithm.class);
        isMethod(isNameExpr);
    }

    private void isMethod() {
        Intent isVariable = new Intent(this, OesilScore.class);
        isMethod(isNameExpr);
    }

    private void isMethod() {
        Intent isVariable = new Intent(this, EgsysScore.class);
        isMethod(isNameExpr);
    }
}
