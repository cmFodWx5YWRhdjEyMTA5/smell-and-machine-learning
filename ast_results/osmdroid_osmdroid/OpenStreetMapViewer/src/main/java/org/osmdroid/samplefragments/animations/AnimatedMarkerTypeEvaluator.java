        ...
        switch(isNameExpr.isMethod()) {
            case isNameExpr.isFieldAccessExpr.isFieldAccessExpr:
                if (isNameExpr != null && isNameExpr.isMethod())
                    isNameExpr.isMethod();
                GeoPoint isVariable = new GeoPoint((isNameExpr.isMethod() * isIntegerConstant) - isIntegerConstant, (isNameExpr.isMethod() * isIntegerConstant) - isIntegerConstant);
                isNameExpr = isNameExpr.isMethod(isNameExpr, isNameExpr, isNameExpr, new GeoPointInterpolator.Spherical());
                break;
        }
    }
}
