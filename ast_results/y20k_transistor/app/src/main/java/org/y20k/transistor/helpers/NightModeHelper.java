 ...
 * isComment
 */
public final class isClassOrIsInterface implements TransistorKeys {

    /*isComment*/
    private static final String isVariable = NightModeHelper.class.isMethod();
    ...
    /*isComment*/
    private static void isMethod(Context isParameter, int isParameter) {
