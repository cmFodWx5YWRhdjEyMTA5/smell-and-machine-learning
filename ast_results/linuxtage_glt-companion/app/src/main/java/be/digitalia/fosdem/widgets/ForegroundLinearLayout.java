...
public class isClassOrIsInterface extends LinearLayoutCompat {
    ...
    public isConstructor(Context isParameter, AttributeSet isParameter, int isParameter) {
        ...
        final Drawable isVariable = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        if (isNameExpr != null) {
            isMethod(isNameExpr);
        }
    ...
    @Override
    protected boolean isMethod(@NonNull Drawable isParameter) {
    ...
    public void isMethod(@NonNull Canvas isParameter) {
        ...
        if (isNameExpr != null) {
            ...
            if (isNameExpr) {
                ...
                isNameExpr.isMethod(isNameExpr, isNameExpr.isMethod(), isNameExpr.isMethod(), isNameExpr, isNameExpr);
                isNameExpr.isMethod(isNameExpr);
            }
            isNameExpr.isMethod(isNameExpr);
        }
