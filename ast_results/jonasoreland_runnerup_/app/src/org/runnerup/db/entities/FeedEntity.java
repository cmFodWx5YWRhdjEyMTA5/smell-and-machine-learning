...
public class isClassOrIsInterface extends AbstractEntity {
    ...
    public void isMethod(Long isParameter) {
        isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr);
    }

    public Long isMethod() {
        if (isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr)) {
            return isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr);
        }
        return null;
    }
