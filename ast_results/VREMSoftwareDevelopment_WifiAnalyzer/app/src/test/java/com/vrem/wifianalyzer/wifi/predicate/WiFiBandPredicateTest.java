...
public class isClassOrIsInterface {
    ...
    public void isMethod() {
        ...
        // isComment
        isMethod(new WiFiBandPredicate(isNameExpr.isFieldAccessExpr).isMethod(isNameExpr));
        isMethod(new WiFiBandPredicate(isNameExpr.isFieldAccessExpr).isMethod(isNameExpr));
    }
    ...
    private WiFiDetail isMethod(int isParameter) {
        WiFiSignal isVariable = new WiFiSignal(isNameExpr, isNameExpr, isNameExpr.isFieldAccessExpr, isIntegerConstant);
