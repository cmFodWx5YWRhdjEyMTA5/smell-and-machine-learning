...
public class isClassOrIsInterface {
    ...
    private WiFiBandAdapter isVariable;

    @Before
    public void isMethod() {
        isNameExpr = new WiFiBandAdapter(isNameExpr.isMethod(WiFiBand.class));
    }
    ...
    @Test
    public void isMethod() {
        isNameExpr.isMethod(isNameExpr.isMethod(WiFiBand.class), new ContainsClosure());
    }
    ...
    public void isMethod() {
        // isComment
        Set<WiFiBand> isVariable = isNameExpr.isMethod();
        // isComment
    ...
    private class isClassOrIsInterface implements Closure<WiFiBand> {
