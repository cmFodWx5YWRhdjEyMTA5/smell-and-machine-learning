...
public class isClassOrIsInterface {
    ...
    private List<Locale> isVariable;

    private LanguagePreference isVariable;

    @Before
    public void isMethod() {
        MainActivity isVariable = isNameExpr.isFieldAccessExpr.isMethod();
        isNameExpr = new LanguagePreference(isNameExpr, isNameExpr.isMethod().isMethod());
