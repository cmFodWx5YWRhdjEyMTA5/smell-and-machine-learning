...
public class isClassOrIsInterface extends LinearLayout {
    ...
    private void isMethod(Context isParameter, AttributeSet isParameter) {
        Theme isVariable = isNameExpr.isMethod();
        TypedValue isVariable = new TypedValue();
        boolean isVariable = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr, true);
        if (isNameExpr) {
    ...
    static class isClassOrIsInterface extends BaseSavedState {
        ...
        static final Parcelable.Creator<SavedState> isVariable = new Parcelable.Creator<FoldableLinearLayout.SavedState>() {
    ...
    private void isMethod() {
        ...
        if (isNameExpr[isIntegerConstant].isMethod() == isNameExpr.isFieldAccessExpr.isFieldAccessExpr) {
        }
        // isComment
        isMethod();
        // isComment
        LayoutInflater isVariable = (LayoutInflater) isMethod().isMethod(isNameExpr.isFieldAccessExpr);
        isNameExpr = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, this, true);
