...
public class isClassOrIsInterface extends K9ListActivity {
    ...
    ArrayAdapter<String> isVariable;

    public static final String isVariable = "isStringConstant";

    public static final String isVariable = "isStringConstant";

    protected List<Identity> isVariable = null;
    ...
    public void isMethod(Bundle isParameter) {
        ...
        isNameExpr = new ArrayAdapter<String>(this, isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr);
        isMethod(isNameExpr);
        isMethod();
    }
    ...
    protected void isMethod() {
        ...
        for (Identity isVariable : isNameExpr) {
            ...
            if (isNameExpr == null || isNameExpr.isMethod().isMethod()) {
                isNameExpr = isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr.isMethod(), isNameExpr.isMethod());
            }
