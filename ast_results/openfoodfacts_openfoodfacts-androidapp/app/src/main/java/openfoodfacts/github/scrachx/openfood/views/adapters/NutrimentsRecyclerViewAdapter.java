 ...
 * isComment
 */
public class isClassOrIsInterface extends RecyclerView.Adapter {

    private static final int isVariable = isIntegerConstant;

    private static final int isVariable = isIntegerConstant;

    private final List<NutrimentItem> isVariable;

    public isConstructor(List<NutrimentItem> isParameter) {
        super();
    ...
    public RecyclerView.ViewHolder isMethod(ViewGroup isParameter, int isParameter) {
        ...
        return isNameExpr ? new NutrimentHeaderViewHolder(isNameExpr) : new NutrimentViewHolder(isNameExpr);
    }

    @Override
    public void isMethod(RecyclerView.ViewHolder isParameter, int isParameter) {
        if (!(isNameExpr instanceof NutrimentViewHolder)) {
            return;
        }
        NutrimentItem isVariable = isNameExpr.isMethod(isNameExpr);
        NutrimentViewHolder isVariable = (NutrimentViewHolder) isNameExpr;
