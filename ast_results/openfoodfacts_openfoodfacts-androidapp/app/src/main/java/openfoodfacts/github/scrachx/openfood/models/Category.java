...
public class isClassOrIsInterface {
    ...
    private List<CategoryName> isVariable;
     ...
     */
    @Generated(hash = isIntegerConstant)
    private transient CategoryDao isVariable;
    ...
    @Keep
    public isConstructor(String isParameter, List<CategoryName> isParameter, String isParameter) {
        this.isFieldAccessExpr = isNameExpr;
        this.isFieldAccessExpr = isNameExpr;
        this.isFieldAccessExpr = isNameExpr;
    ...
    @Keep
    public isConstructor(String isParameter, List<CategoryName> isParameter) {
        this.isFieldAccessExpr = isNameExpr;
        this.isFieldAccessExpr = isNameExpr;
        this.isFieldAccessExpr = true;
    }
     ...
     */
    @Generated(hash = isIntegerConstant)
    public List<CategoryName> isMethod() {
        if (isNameExpr == null) {
            ...
            List<CategoryName> isVariable = isNameExpr.isMethod(isNameExpr);
            synchronized (this) {
                if (isNameExpr == null) {
