...
public class isClassOrIsInterface extends BaseAdapter {
    ...
    private final List<Ligne> isVariable;

    public isConstructor(Context isParameter, List<Ligne> isParameter) throws KeolisException {
    ...
    public Ligne isMethod(int isParameter) {
    ...
    public View isMethod(int isParameter, View isParameter, ViewGroup isParameter) {
        ...
        if (isNameExpr == null) {
            ...
            isNameExpr = (LigneAdapter.ViewHolder) isNameExpr.isMethod();
        }
        Ligne isVariable = isNameExpr.isMethod(isNameExpr);
