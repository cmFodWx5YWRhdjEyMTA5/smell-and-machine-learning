 ...
 * isComment
 */
public class isClassOrIsInterface extends ArrayAdapter<Arret> {

    private final List<Arret> isVariable;
    ...
    public View isMethod(int isParameter, View isParameter, ViewGroup isParameter) {
        ...
        Arret isVariable = isNameExpr.isMethod(isNameExpr);
        TimeoAdapter.ViewHolder isVariable;
        if (isNameExpr == null) {
            isNameExpr = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, null);
            isNameExpr = new TimeoAdapter.ViewHolder();
            ...
            isNameExpr = (TimeoAdapter.ViewHolder) isNameExpr.isMethod();
        }
    ...
    private CharSequence isMethod(Arret isParameter) {
        try {
            List<DetailArretConteneur> isVariable = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isIntegerConstant, isNameExpr, isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
            return isNameExpr.isMethod() ? "isStringConstant" : isNameExpr.isMethod(isNameExpr, isNameExpr.isMethod(isIntegerConstant).isMethod(), isNameExpr);
