...
public class isClassOrIsInterface {
    ...
    private static final LogYbo isVariable = new LogYbo(WidgetLowResUpdateUtil.class);

    private isConstructor() {
    }

    public static void isMethod(Context isParameter, RemoteViews isParameter, ArretFavori isParameter, Calendar isParameter) {
        ...
        Intent isVariable = new Intent(isNameExpr, TransportsWidget.class);
        ...
        try {
            List<DetailArretConteneur> isVariable = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, isNameExpr.isFieldAccessExpr, isIntegerConstant, isNameExpr, isNameExpr.isFieldAccessExpr);
            ...
            if (isNameExpr.isMethod() > isIntegerConstant) {
                ...
                if ((isNameExpr - isNameExpr) >= isIntegerConstant && (isNameExpr - isNameExpr) < isIntegerConstant) {
                    isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr.isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr));
                } else {
                    isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr.isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr));
                }
                isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isMethod(isNameExpr.isMethod(isIntegerConstant).isMethod()));
            } else {
                isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, "isStringConstant");
            }
            isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr.isMethod() < isIntegerConstant ? "isStringConstant" : isMethod(isNameExpr.isMethod(isIntegerConstant).isMethod()));
