...
public class isClassOrIsInterface implements Serializable {
    ...
    public static PortionTrajet isMethod(Leg isParameter) {
        PortionTrajet isVariable = new PortionTrajet();
    ...
    private TraverseMode isVariable;
    ...
    private EncodedPolylineBean isVariable;

    public TraverseMode isMethod() {
        return isNameExpr;
    }
    ...
    public EncodedPolylineBean isMethod() {
        return isNameExpr;
    }
}
