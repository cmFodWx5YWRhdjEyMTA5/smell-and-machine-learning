...
public class isClassOrIsInterface extends BaseAdapter {
    ...
    private ArrayList<HashMap<String, String>> isVariable;

    private static LayoutInflater isVariable = null;

    public isConstructor(Activity isParameter, ArrayList<HashMap<String, String>> isParameter) {
