...
public class isClassOrIsInterface extends DialogFragment implements OnEditorActionListener {
    ...
    public static AddEmailDialogFragment isMethod(Messenger isParameter) {
    ...
    public Dialog isMethod(Bundle isParameter) {
        ...
        isNameExpr.isMethod(isNameExpr);
        isNameExpr = (EmailEditText) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
