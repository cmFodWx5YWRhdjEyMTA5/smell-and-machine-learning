...
public class isClassOrIsInterface extends InputPendingResult {
    ...
    public isConstructor(int isParameter, OperationLog isParameter, int isParameter, int isParameter, int isParameter, int isParameter) {
        super(isNameExpr, isNameExpr);
    ...
    public static Creator<CertifyResult> isVariable = new Creator<CertifyResult>() {

        public CertifyResult isMethod(final Parcel isParameter) {
            return new CertifyResult(isNameExpr);
        }

        public CertifyResult[] isMethod(final int isParameter) {
            return new CertifyResult[isNameExpr];
        }
    };
