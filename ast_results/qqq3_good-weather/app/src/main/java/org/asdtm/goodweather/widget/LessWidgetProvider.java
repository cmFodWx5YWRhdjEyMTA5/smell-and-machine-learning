...
public class isClassOrIsInterface extends AppWidgetProvider {
    ...
    public void isMethod(Context isParameter) {
        ...
        AppWidgetProviderAlarm isVariable = new AppWidgetProviderAlarm(isNameExpr, LessWidgetProvider.class);
        isNameExpr.isMethod();
    }
        ...
        switch(isNameExpr.isMethod()) {
            case isNameExpr.isFieldAccessExpr:
                if (isNameExpr.isMethod(isNameExpr)) {
                    isNameExpr.isMethod(new Intent(isNameExpr, LocationUpdateService.class));
                } else {
                    isNameExpr.isMethod(new Intent(isNameExpr, LessWidgetService.class));
                }
                break;
            case isNameExpr.isFieldAccessExpr:
                isNameExpr.isMethod(new Intent(isNameExpr, LessWidgetService.class));
            ...
            case isNameExpr.isFieldAccessExpr:
                ...
                ComponentName isVariable = new ComponentName(isNameExpr, LessWidgetProvider.class);
    ...
    public void isMethod(Context isParameter, AppWidgetManager isParameter, int[] isParameter) {
        ...
        for (int isVariable : isNameExpr) {
            ...
            isMethod(isNameExpr, isNameExpr);
            Intent isVariable = new Intent(isNameExpr, LessWidgetProvider.class);
    ...
    private void isMethod(Context isParameter, RemoteViews isParameter) {
        SharedPreferences isVariable = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, isNameExpr.isFieldAccessExpr);
        String isVariable = isNameExpr.isMethod(isNameExpr);
        String isVariable = isNameExpr.isMethod(isNameExpr.isMethod(), "isStringConstant", isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, isIntegerConstant));
