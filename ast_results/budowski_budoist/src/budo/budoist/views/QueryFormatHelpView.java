...
public class isClassOrIsInterface extends Activity {
    ...
    private static final String isVariable = QueryFormatHelpView.class.isMethod();

    private TodoistApplication isVariable;
    ...
    public void isMethod(final Bundle isParameter) {
        ...
        isNameExpr = (TodoistApplication) isMethod();
        ...
        isNameExpr.isMethod((new SimpleDateFormat("isStringConstant", isNameExpr.isFieldAccessExpr)).isMethod(isNameExpr.isFieldAccessExpr));
        isNameExpr = (TextView) isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        isNameExpr.isFieldAccessExpr = "isStringConstant";
        isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, isNameExpr.isFieldAccessExpr);
        isNameExpr.isMethod((new SimpleDateFormat("isStringConstant", isNameExpr.isFieldAccessExpr)).isMethod(isNameExpr.isFieldAccessExpr));
