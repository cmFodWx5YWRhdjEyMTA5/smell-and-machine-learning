...
public class isClassOrIsInterface implements Parcelable {
    ...
    public static final Creator<TakePhotoNoteParams> isVariable = new Creator<TakePhotoNoteParams>() {

        @Override
        public TakePhotoNoteParams isMethod(Parcel isParameter) {
            return new TakePhotoNoteParams(isNameExpr);
        }

        @Override
        public TakePhotoNoteParams[] isMethod(int isParameter) {
            return new TakePhotoNoteParams[isNameExpr];
        }
    };
