...
public class isClassOrIsInterface extends QuickAction {
    ...
    public void isMethod(MapActivity isParameter) {
        ...
        PointDescription isVariable = new PointDescription(isNameExpr.isMethod(), isNameExpr.isMethod());
        ...
        isNameExpr.isMethod().isMethod(isNameExpr.isMethod(), isNameExpr.isMethod(), isNameExpr, null);
    }
