...
public class isClassOrIsInterface extends DialogPreference {
     ...
     * isComment
     */
    private ColorPicker isVariable;
    ...
    public isConstructor(Context isParameter, AttributeSet isParameter, int isParameter) {
        ...
        isNameExpr = new ColorPicker(isNameExpr, isNameExpr);
        // isComment
    ...
    protected void isMethod(View isParameter) {
        ...
        ColorPicker isVariable = isNameExpr;
        isNameExpr.isMethod(isMethod() == null ? isNameExpr.isFieldAccessExpr : isNameExpr.isMethod(isMethod()));
     ...
     * isComment
     */
    protected void isMethod(View isParameter, ColorPicker isParameter) {
    ...
    protected void isMethod(boolean isParameter, Object isParameter) {
        isMethod(isNameExpr ? isMethod(isNameExpr) : (String) isNameExpr);
    }

    @Override
    public boolean isMethod() {
        return isNameExpr.isMethod(isNameExpr) || super.isMethod();
    }
