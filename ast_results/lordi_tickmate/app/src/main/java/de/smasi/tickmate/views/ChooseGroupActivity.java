...
public class isClassOrIsInterface extends ListActivity {
    ...
    protected void isMethod(Bundle isParameter) {
        ...
        // isComment
        isMethod();
        XmlResourceParser isVariable = isMethod().isMethod(isMethod().isMethod("isStringConstant", "isStringConstant", isMethod()));
        int isVariable;
        List<Group> isVariable = new LinkedList<>();
        try {
            ...
            while (isNameExpr != isNameExpr.isFieldAccessExpr) {
                if (isNameExpr == isNameExpr.isFieldAccessExpr) {
                    ...
                    if (isNameExpr.isMethod().isMethod("isStringConstant")) {
                        ...
                        Group isVariable = new Group(isNameExpr, isNameExpr);
                        // isComment
                        // isComment
                        isNameExpr.isMethod(isNameExpr);
                    } else if (isNameExpr.isMethod().isMethod("isStringConstant")) {
                        Group isVariable = new Group(isNameExpr.isMethod(null, "isStringConstant"));
        ...
        Group[] isVariable = new Group[isNameExpr.isMethod()];
        isNameExpr.isMethod(isNameExpr);
        isNameExpr = new GroupListAdapter(this, isNameExpr);
        this.isMethod().isMethod(isNameExpr);
    }

    @Override
    protected void isMethod(ListView isParameter, View isParameter, int isParameter, long isParameter) {
        Group isVariable = (Group) isMethod().isMethod().isMethod(isNameExpr);
