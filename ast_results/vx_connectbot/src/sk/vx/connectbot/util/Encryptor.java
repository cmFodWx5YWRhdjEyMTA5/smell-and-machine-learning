...
public final class isClassOrIsInterface {
     ...
     * isComment
     */
    public static byte[] isMethod(final byte[] isParameter, final int isParameter, final String isParameter, final byte[] isParameter) throws Exception {
        /*isComment*/
        isNameExpr.isMethod(isNameExpr).isMethod(isNameExpr);
        /*isComment*/
        final MessageDigest isVariable = isNameExpr.isMethod(isNameExpr);
        byte[] isVariable = isNameExpr.isMethod(isNameExpr);
        for (int isVariable = isIntegerConstant; isNameExpr < isNameExpr; isNameExpr++) {
            /*isComment*/
            final byte[] isVariable = new byte[isNameExpr.isFieldAccessExpr + isNameExpr.isFieldAccessExpr];
        ...
        isNameExpr.isMethod(isNameExpr, (byte) isIntegerConstant);
        /*isComment*/
        final Cipher isVariable = isNameExpr.isMethod(isNameExpr);
        isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, new SecretKeySpec(isNameExpr, isNameExpr), new IvParameterSpec(isNameExpr));
        isNameExpr.isMethod(isNameExpr, (byte) isIntegerConstant);
        isNameExpr.isMethod(isNameExpr, (byte) isIntegerConstant);
