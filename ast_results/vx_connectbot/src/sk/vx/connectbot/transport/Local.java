...
public class isClassOrIsInterface extends AbsTransport {
    ...
    private FileDescriptor isVariable;

    private FileInputStream isVariable;

    private FileOutputStream isVariable;
    ...
    public void isMethod() {
        ...
        try {
            isNameExpr = isNameExpr.isMethod("isStringConstant", "isStringConstant", null, isNameExpr);
