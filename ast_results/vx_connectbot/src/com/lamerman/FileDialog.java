...
public class isClassOrIsInterface extends ListActivity {
    ...
    private ArrayList<HashMap<String, Object>> isVariable;
    ...
    public void isMethod(Bundle isParameter) {
        ...
        this.isMethod(isNameExpr.isMethod("isStringConstant", isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr), isMethod().isMethod(isNameExpr)));
        ...
        isNameExpr.isMethod(new OnClickListener() {
            ...
            public void isMethod(View isParameter) {
                if (isNameExpr.isMethod().isMethod() > isIntegerConstant) {
                    isMethod().isMethod(isNameExpr, isNameExpr + "isStringConstant" + isNameExpr.isMethod());
                    isMethod(isNameExpr, isMethod());
                    isMethod();
                }
            }
    ...
    private void isMethod(final String isParameter) {
        ...
        isNameExpr = new ArrayList<HashMap<String, Object>>();
        ...
        TreeMap<String, String> isVariable = new TreeMap<String, String>();
        TreeMap<String, String> isVariable = new TreeMap<String, String>();
        TreeMap<String, String> isVariable = new TreeMap<String, String>();
        TreeMap<String, String> isVariable = new TreeMap<String, String>();
        ...
        isNameExpr.isMethod(isNameExpr.isMethod("isStringConstant").isMethod());
        isNameExpr.isMethod(isNameExpr.isMethod("isStringConstant").isMethod());
        SimpleAdapter isVariable = new SimpleAdapter(this, isNameExpr, isNameExpr.isFieldAccessExpr.isFieldAccessExpr, new String[] { isNameExpr, isNameExpr }, new int[] { isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr.isFieldAccessExpr.isFieldAccessExpr });
        for (String isVariable : isNameExpr.isMethod("isStringConstant").isMethod()) {
            isMethod(isNameExpr, isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        }
        for (String isVariable : isNameExpr.isMethod("isStringConstant").isMethod()) {
            isMethod(isNameExpr, isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
    ...
    private void isMethod(String isParameter, int isParameter) {
        HashMap<String, Object> isVariable = new HashMap<String, Object>();
        isNameExpr.isMethod(isNameExpr, isNameExpr);
        isNameExpr.isMethod(isNameExpr, isNameExpr);
        isNameExpr.isMethod(isNameExpr);
    }
    ...
    protected void isMethod(ListView isParameter, View isParameter, int isParameter, long isParameter) {
        ...
        if (isNameExpr.isMethod()) {
            ...
            if (isNameExpr.isMethod()) {
                ...
                new AlertDialog.Builder(this).isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr).isMethod("isStringConstant" + isNameExpr.isMethod() + "isStringConstant" + isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr)).isMethod("isStringConstant", new DialogInterface.OnClickListener() {
