...
public final class isClassOrIsInterface extends UnitConverter {
    ...
    public UnitConverter isMethod() {
        return new AddConverter(-isNameExpr);
    }
    ...
    public UnitConverter isMethod(UnitConverter isParameter) {
        if (isNameExpr instanceof AddConverter) {
            double isVariable = isNameExpr + ((AddConverter) isNameExpr).isFieldAccessExpr;
    ...
    private static UnitConverter isMethod(double isParameter) {
        ...
        return isNameExpr == isDoubleConstant ? isNameExpr.isFieldAccessExpr : new AddConverter(isNameExpr);
    }
