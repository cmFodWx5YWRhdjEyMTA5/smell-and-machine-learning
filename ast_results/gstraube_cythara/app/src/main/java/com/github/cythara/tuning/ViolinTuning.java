...
public class isClassOrIsInterface implements Tuning {
    ...
    private enum Pitch implements com.github.cythara.Note {
        ...
        G3(isNameExpr, isIntegerConstant, isDoubleConstant), D4(isNameExpr, isIntegerConstant, isDoubleConstant), A4(isNameExpr, isIntegerConstant, isDoubleConstant), E5(isNameExpr, isIntegerConstant, isDoubleConstant);
