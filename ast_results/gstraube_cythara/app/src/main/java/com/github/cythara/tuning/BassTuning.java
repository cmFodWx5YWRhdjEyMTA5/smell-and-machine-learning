...
public class isClassOrIsInterface implements Tuning {
    ...
    private enum Pitch implements com.github.cythara.Note {
        ...
        E1(isNameExpr, isIntegerConstant, isDoubleConstant), A1(isNameExpr, isIntegerConstant, isDoubleConstant), D2(isNameExpr, isIntegerConstant, isDoubleConstant), G2(isNameExpr, isIntegerConstant, isDoubleConstant);
