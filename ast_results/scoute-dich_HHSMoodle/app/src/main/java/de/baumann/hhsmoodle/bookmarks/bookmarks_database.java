...
public class isClassOrIsInterface {
    ...
    // isComment
    public void isMethod(int isParameter, String isParameter, String isParameter, String isParameter, String isParameter, String isParameter) {
    ...
    // isComment
    public Cursor isMethod(Context isParameter) {
        ...
        switch(isNameExpr.isMethod("isStringConstant", "isStringConstant")) {
            ...
            case "isStringConstant":
                {
                    ...
                    return isNameExpr.isMethod(isNameExpr, isNameExpr, null, null, null, null, isNameExpr);
                }
        }
        return null;
    }
