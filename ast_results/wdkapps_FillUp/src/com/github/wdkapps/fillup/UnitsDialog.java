...
public class isClassOrIsInterface {
    ...
    public interface isClassOrIsInterface {
         ...
         * isComment
         */
        public void isMethod(int isParameter, Result isParameter, String isParameter);
    }

    /**
     * isComment
     */
    public static Dialog isMethod(Context isParameter, final Listener isParameter, final int isParameter) {
        final Resources isVariable = isNameExpr.isMethod();
        // isComment
        AlertDialog.Builder isVariable = new AlertDialog.Builder(isNameExpr);
        isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr).isMethod(isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr)).isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, new DialogInterface.OnClickListener() {
