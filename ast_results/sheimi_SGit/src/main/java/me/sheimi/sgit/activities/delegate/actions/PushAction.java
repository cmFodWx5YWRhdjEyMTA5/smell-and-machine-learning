...
public class isClassOrIsInterface extends RepoAction {
    ...
    public void isMethod() {
        ...
        PushDialog isVariable = new PushDialog();
        isNameExpr.isMethod(isNameExpr.isMethod());
        isNameExpr.isMethod(isNameExpr.isMethod(), "isStringConstant");
        isNameExpr.isMethod();
    }

    public static void isMethod(Repo isParameter, RepoDetailActivity isParameter, String isParameter, boolean isParameter, boolean isParameter) {
        PushTask isVariable = new PushTask(isNameExpr, isNameExpr, isNameExpr, isNameExpr, isNameExpr.new ProgressCallback(isNameExpr.isFieldAccessExpr.isFieldAccessExpr));
        isNameExpr.isMethod();
    }

    public static class isClassOrIsInterface extends SheimiDialogFragment {
        ...
        public Dialog isMethod(Bundle isParameter) {
            ...
            isNameExpr = (RepoDetailActivity) isMethod();
            ...
            isNameExpr = new ArrayAdapter<String>(isNameExpr, isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr);
            Set<String> isVariable = isNameExpr.isMethod();
            ...
            isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr).isMethod(isNameExpr).isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, new DummyDialogListener());
