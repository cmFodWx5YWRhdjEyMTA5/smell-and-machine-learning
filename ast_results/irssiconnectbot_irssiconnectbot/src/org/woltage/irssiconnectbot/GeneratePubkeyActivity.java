...
public class isClassOrIsInterface extends Activity implements OnEntropyGatheredListener {
    ...
    public void isMethod(Bundle isParameter) {
        ...
        isNameExpr = (RadioGroup) isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        isNameExpr = (EditText) isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
    ...
    private void isMethod() {
        ...
        ((EntropyView) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr)).isMethod(isNameExpr.this);
        isNameExpr = new EntropyDialog(isNameExpr.this, isNameExpr);
        isNameExpr.isMethod();
    }
    ...
    public void isMethod(byte[] isParameter) {
        ...
        for (int isVariable = isIntegerConstant; isNameExpr < isIntegerConstant; isNameExpr++) isNameExpr += isMethod(this.isFieldAccessExpr[isNameExpr]);
        isNameExpr.isMethod(isNameExpr, "isStringConstant" + (int) (isDoubleConstant * isNameExpr / isDoubleConstant) + "isStringConstant");
    ...
    private void isMethod() {
        ...
        isNameExpr.isMethod(isNameExpr.this.isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr));
        isNameExpr.isMethod(true);
        isNameExpr.isMethod(true);
        isNameExpr.isMethod();
    ...
    private final Runnable isVariable = new Runnable() {
        ...
        public void isMethod() {
            try {
                boolean isVariable = true;
                SecureRandom isVariable = isNameExpr.isMethod("isStringConstant");
                isNameExpr.isMethod(isNameExpr);
                KeyPairGenerator isVariable = isNameExpr.isMethod(isNameExpr);
                isNameExpr.isMethod(isNameExpr, isNameExpr);
                KeyPair isVariable = isNameExpr.isMethod();
                PrivateKey isVariable = isNameExpr.isMethod();
                ...
                isNameExpr.isMethod(isNameExpr.isMethod());
                PubkeyDatabase isVariable = new PubkeyDatabase(isNameExpr.this);
                isNameExpr.isMethod(isNameExpr);
                isNameExpr.isMethod();
