...
public class isClassOrIsInterface extends Format {
    ...
    public StringBuffer isMethod(@NonNull final Object isParameter, @NonNull final StringBuffer isParameter, @Nullable final FieldPosition isParameter) {
        ...
        final long isVariable = -((isNameExpr - isNameExpr.isMethod()) / isNameExpr) / isIntegerConstant;
        final float isVariable = ((float) isNameExpr) / isDoubleConstant;
        isNameExpr.isMethod(new DecimalFormat("isStringConstant").isMethod(isNameExpr));
        return isNameExpr;
    }
