    ...
    void isMethod(boolean isParameter) {
        ...
        if (isNameExpr) {
            ...
            if (isNameExpr) {
                ...
                isNameExpr = isNameExpr.isMethod(new WifiServer(isNameExpr, isNameExpr, isNameExpr), isNameExpr);
            } else {
                isNameExpr = isNameExpr.isMethod(new WifiServer(isNameExpr, isNameExpr, isNameExpr, isNameExpr));
            }
        } else {
        ...
        isNameExpr.isMethod(isNameExpr.isMethod(isNameExpr));
        isMethod().isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr);
        isMethod().isMethod();
    }
