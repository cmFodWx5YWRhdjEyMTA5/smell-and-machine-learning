...
public class isClassOrIsInterface extends Activity {
    ...
    public void isMethod(Bundle isParameter) {
        ...
        this.isFieldAccessExpr = (TextView) this.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        this.isFieldAccessExpr = (Button) this.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        ...
        this.isFieldAccessExpr.isMethod("isStringConstant" + isNameExpr + "isStringConstant" + isNameExpr);
