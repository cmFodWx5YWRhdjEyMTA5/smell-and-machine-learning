...
public class isClassOrIsInterface extends AppCompatActivity {
    ...
    private SynchServiceReceiver isVariable;
    ...
    protected void isMethod(Bundle isParameter) {
        ...
        if (isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr) != null) {
            ...
            // isComment
            // isComment
            ((MainAdapter) isNameExpr.isMethod()).isMethod(true);
        }
        new Style(this);
        this.isFieldAccessExpr = new SynchServiceReceiver();
        isMethod(this.isFieldAccessExpr, new IntentFilter(isNameExpr.isFieldAccessExpr));
        ...
        if (isNameExpr != null)
            isNameExpr.isMethod(new View.OnClickListener() {
                ...
                public void isMethod(View isParameter) {
                    ...
                    isNameExpr.isMethod(isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr) + "isStringConstant");
                    // isComment
                    ...
                    isNameExpr.isMethod("isStringConstant", new DialogInterface.OnClickListener() {
                        ...
                        public void isMethod(DialogInterface isParameter, int isParameter) {
                            ...
                            ((MainAdapter) isNameExpr.isMethod()).isMethod();
    ...
    public void isMethod(View isParameter) {
        isMethod(new Intent(this, WizardActivity.class));
    }
    ...
    private void isMethod(@NonNull RecyclerView isParameter) {
        isNameExpr.isMethod(new MainAdapter(this));
    }
