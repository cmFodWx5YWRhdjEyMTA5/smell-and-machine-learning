 ...
 * isComment
 */
public class isClassOrIsInterface extends ArrayAdapter<BusStop> {

    private final Context isVariable;

    public isConstructor(Context isParameter, List<BusStop> isParameter) {
    ...
    public View isMethod(int isParameter, View isParameter, @NonNull ViewGroup isParameter) {
        BusStop isVariable = isMethod(isNameExpr);
        TextView isVariable;
        if (isNameExpr == null) {
        ...
        if (isNameExpr != null) {
            ...
            Spannable isVariable = (Spannable) isNameExpr.isMethod();
            isNameExpr.isMethod(new ForegroundColorSpan(isNameExpr.isMethod(isNameExpr, isNameExpr.isFieldAccessExpr.isFieldAccessExpr)), isNameExpr.isMethod("isStringConstant", "isStringConstant").isMethod("isStringConstant", "isStringConstant").isMethod() + isIntegerConstant, isNameExpr.isMethod(), isNameExpr.isFieldAccessExpr);
        } else {
            isNameExpr.isMethod(isNameExpr);
        }
        return isNameExpr;
