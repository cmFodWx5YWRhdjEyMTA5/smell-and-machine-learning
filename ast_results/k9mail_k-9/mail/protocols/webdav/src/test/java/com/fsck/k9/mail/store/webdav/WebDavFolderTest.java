...
public class isClassOrIsInterface {
    ...
    @Captor
    private ArgumentCaptor<String> isVariable;

    @Captor
    private ArgumentCaptor<StringEntity> isVariable;
    ...
    public void isMethod() throws MessagingException, IOException {
        ...
        isMethod(isNameExpr.isMethod()).isMethod(isNameExpr);
        isMethod(isNameExpr.isMethod()).isMethod(isNameExpr);
        isMethod(isNameExpr.isMethod(isMethod(String[].class))).isMethod("isStringConstant");
        isMethod(isNameExpr.isMethod(isMethod(String[].class))).isMethod("isStringConstant");
        isNameExpr = new WebDavFolder(isNameExpr, isNameExpr);
        isMethod();
    }
    ...
    private WebDavMessage isMethod(int isParameter) {
    ...
    public void isMethod() throws MessagingException {
        ...
        for (int isVariable = isIntegerConstant; isNameExpr < isIntegerConstant; isNameExpr++) {
            WebDavMessage isVariable = isMethod(isNameExpr);
            isNameExpr.isMethod(isNameExpr);
        }
    ...
    public void isMethod() throws MessagingException, IOException {
        ...
        isMethod(isNameExpr.isMethod()).isMethod(isNameExpr);
        isNameExpr.isMethod(isNameExpr);
        isMethod(isNameExpr).isMethod(isNameExpr.isMethod(), isMethod("isStringConstant"), isNameExpr.isMethod(), isNameExpr.<Map<String, String>>isMethod(null), isMethod(true));
        isMethod(isNameExpr.isMethod().isMethod(isNameExpr + "isStringConstant" + isNameExpr + "isStringConstant" + isNameExpr));
