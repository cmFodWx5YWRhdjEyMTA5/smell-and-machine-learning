    ...
    public int isMethod() throws IOException {
        ...
        switch(isNameExpr) {
            ...
            case isNameExpr:
                ...
                isNameExpr = isNameExpr + (isNameExpr % isIntegerConstant == isIntegerConstant ? isIntegerConstant : isNameExpr < isIntegerConstant ? isIntegerConstant : isIntegerConstant);
                isNameExpr = true;
                return isNameExpr;
            default:
