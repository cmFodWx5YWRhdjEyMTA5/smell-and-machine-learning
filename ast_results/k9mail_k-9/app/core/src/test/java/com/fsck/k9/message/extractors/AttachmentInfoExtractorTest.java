...
public class isClassOrIsInterface extends RobolectricTest {
    ...
    public void isMethod() throws Exception {
        ...
        isNameExpr = new AttachmentInfoExtractor(isNameExpr);
    }
    ...
    @Test
    public void isMethod() throws Exception {
        LocalBodyPart isVariable = new LocalBodyPart(isNameExpr, null, isNameExpr, isNameExpr);
        isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, isNameExpr);
        AttachmentViewInfo isVariable = isNameExpr.isMethod(isNameExpr);
        isMethod(isNameExpr.isMethod(isNameExpr, isNameExpr), isNameExpr.isFieldAccessExpr);
    ...
    @Test
    public void isMethod() throws Exception {
        Part isVariable = new MimeBodyPart();
        isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, isNameExpr.isFieldAccessExpr + "isStringConstant" + isNameExpr + "isStringConstant");
        AttachmentViewInfo isVariable = isNameExpr.isMethod(isNameExpr);
        isMethod("isStringConstant", isNameExpr.isFieldAccessExpr);
    }
    ...
    public void isMethod() throws Exception {
        ...
        isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, isNameExpr.isFieldAccessExpr + "isStringConstant" + "isStringConstant" + "isStringConstant");
        AttachmentViewInfo isVariable = isNameExpr.isMethod(isNameExpr);
        isMethod(isNameExpr.isFieldAccessExpr);
    }
    ...
    public void isMethod() throws Exception {
        MimeBodyPart isVariable = new MimeBodyPart();
        isNameExpr.isMethod(new TextBody("isStringConstant"));
        AttachmentViewInfo isVariable = isNameExpr.isMethod(isNameExpr);
        isMethod(isNameExpr.isMethod());
    }
    ...
    public void isMethod() throws Exception {
        isNameExpr = new AttachmentInfoExtractor(isNameExpr) {
            ...
            @Nullable
            @Override
            protected Uri isMethod(DeferredFileBody isParameter, String isParameter) {
                return isNameExpr;
            }
        };
        DeferredFileBody isVariable = isMethod(DeferredFileBody.class);
