...
public class isClassOrIsInterface extends K9Activity {
    ...
    public static boolean isMethod(Context isParameter, Intent isParameter) {
        ...
        Intent isVariable = new Intent(isNameExpr, UpgradeDatabases.class);
    ...
    private UpgradeDatabaseBroadcastReceiver isVariable;
    ...
    private void isMethod() {
        ...
        isNameExpr = new UpgradeDatabaseBroadcastReceiver();
    ...
    class isClassOrIsInterface extends BroadcastReceiver {
        ...
        @Override
        public void isMethod(Context isParameter, final Intent isParameter) {
