...
public class isClassOrIsInterface extends DialogFragment {
    ...
    private ShowcaseView isVariable;
    ...
    protected void isMethod() {
        ...
        isNameExpr = new Builder(isNameExpr).isMethod(new ViewTarget(isNameExpr, isNameExpr)).isMethod().isMethod().isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr).isMethod();
        isNameExpr.isMethod();
    }
