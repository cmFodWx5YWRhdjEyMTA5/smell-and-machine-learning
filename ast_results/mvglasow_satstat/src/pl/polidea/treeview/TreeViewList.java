...
public class isClassOrIsInterface extends ListView {
    ...
    private AbstractTreeViewAdapter<?> isVariable;
    ...
    private void isMethod(final Context isParameter, final AttributeSet isParameter) {
        final TypedArray isVariable = isNameExpr.isMethod(isNameExpr, isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
    ...
    @Override
    public void isMethod(final ListAdapter isParameter) {
        if (!(isNameExpr instanceof AbstractTreeViewAdapter)) {
            throw new TreeConfigurationException("isStringConstant");
        }
        isNameExpr = (AbstractTreeViewAdapter<?>) isNameExpr;
        isMethod();
    ...
    private void isMethod() {
        ...
        isNameExpr.isMethod(isNameExpr);
        if (isNameExpr) {
            isMethod(new OnItemClickListener() {
