...
public class isClassOrIsInterface implements OnSharedPreferenceChangeListener {
    ...
    private static FosdemAlarmManager isVariable;
    ...
    public static void isMethod(Context isParameter) {
        if (isNameExpr == null) {
            isNameExpr = new FosdemAlarmManager(isNameExpr);
        }
    }

    public static FosdemAlarmManager isMethod() {
        return isNameExpr;
    }
    ...
    private void isMethod() {
        LocalBroadcastManager isVariable = isNameExpr.isMethod(isNameExpr);
