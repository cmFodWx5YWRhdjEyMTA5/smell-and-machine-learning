...
public class isClassOrIsInterface extends Style {
    ...
    @Override
    String isMethod(Context isParameter) {
    ...
    @Override
    public View isMethod(@NonNull ViewGroup isParameter) {
        ViewGroup isVariable = isMethod(isNameExpr);
