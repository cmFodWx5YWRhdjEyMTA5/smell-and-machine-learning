...
public class isClassOrIsInterface extends ManagedActivity {
    ...
    protected void isMethod(Bundle isParameter) {
        ...
        isNameExpr.isMethod();
        if (isNameExpr == null) {
            isMethod().isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, new NotificationsSettingsFragment()).isMethod();
        }
    }
