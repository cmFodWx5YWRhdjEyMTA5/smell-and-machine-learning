...
public class isClassOrIsInterface extends ManagedActivity implements ThemeSettingsFragment.OnThemeSettingsFragmentInteractionListener {
    ...
    protected void isMethod(Bundle isParameter) {
        ...
        isNameExpr.isMethod();
        if (isNameExpr == null) {
            isMethod().isMethod().isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, new ThemeSettingsFragment()).isMethod();
        }
    }
