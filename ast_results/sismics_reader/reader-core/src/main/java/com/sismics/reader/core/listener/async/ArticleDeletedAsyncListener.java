...
public class isClassOrIsInterface {
     ...
     * isComment
     */
    private static final Logger isVariable = isNameExpr.isMethod(ArticleDeletedAsyncListener.class);

    /**
     * isComment
     */
    @Subscribe
    public void isMethod(final ArticleDeletedAsyncEvent isParameter) throws Exception {
