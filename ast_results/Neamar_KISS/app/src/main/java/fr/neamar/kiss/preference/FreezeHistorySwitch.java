...
public class isClassOrIsInterface extends SwitchPreference {
    ...
    protected void isMethod() {
        if (!isMethod()) {
            // isComment
            new AlertDialog.Builder(isMethod()).isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr).isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr, new OnClickListener() {
