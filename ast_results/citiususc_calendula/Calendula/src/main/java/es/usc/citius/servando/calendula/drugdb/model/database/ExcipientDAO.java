 ...
 * isComment
 */
public class isClassOrIsInterface extends GenericDao<Excipient, Long> {

    private static final String isVariable = "isStringConstant";

    private Dao<Excipient, Long> isVariable = null;
    ...
    @Override
    public Dao<Excipient, Long> isMethod() {
        try {
            if (isNameExpr == null)
                isNameExpr = isNameExpr.isMethod(Excipient.class);
            return isNameExpr;
