 ...
 * isComment
 */
public class isClassOrIsInterface extends GenericDao<PrescriptionExcipient, Long> {

    private static final String isVariable = "isStringConstant";

    private Dao<PrescriptionExcipient, Long> isVariable = null;
    ...
    @Override
    public Dao<PrescriptionExcipient, Long> isMethod() {
        try {
            if (isNameExpr == null)
                isNameExpr = isNameExpr.isMethod(PrescriptionExcipient.class);
            return isNameExpr;
