...
public class isClassOrIsInterface extends Entity {
    ...
    public static BlogCommentList isMethod(InputStream isParameter) throws IOException, AppException {
        BlogCommentList isVariable = new BlogCommentList();
        Comment isVariable = null;
        Reply isVariable = null;
        Refer isVariable = null;
        // isComment
                ...
                switch(isNameExpr) {
                    ...
                    case isNameExpr.isFieldAccessExpr:
                        ...
                        if (isNameExpr.isMethod("isStringConstant") && isNameExpr != null) {
                            ...
                            isNameExpr = null;
                        } else if (isNameExpr.isMethod("isStringConstant") && isNameExpr != null && isNameExpr != null) {
                            isNameExpr.isMethod().isMethod(isNameExpr);
                            isNameExpr = null;
                        } else if (isNameExpr.isMethod("isStringConstant") && isNameExpr != null && isNameExpr != null) {
                            isNameExpr.isMethod().isMethod(isNameExpr);
