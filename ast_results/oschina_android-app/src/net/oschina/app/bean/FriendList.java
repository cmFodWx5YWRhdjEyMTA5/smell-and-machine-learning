...
public class isClassOrIsInterface extends Entity {
    ...
    private List<Friend> isVariable = new ArrayList<Friend>();
    ...
    public List<Friend> isMethod() {
        return isNameExpr;
    }

    public void isMethod(List<Friend> isParameter) {
        this.isFieldAccessExpr = isNameExpr;
    }

    public static FriendList isMethod(InputStream isParameter) throws IOException, AppException {
        FriendList isVariable = new FriendList();
        Friend isVariable = null;
        // isComment
