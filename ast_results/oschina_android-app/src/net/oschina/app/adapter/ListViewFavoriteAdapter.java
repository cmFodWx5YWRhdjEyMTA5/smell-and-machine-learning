...
public class isClassOrIsInterface extends BaseAdapter {
    ...
    // isComment
    private List<Favorite> isVariable;
     ...
     * isComment
     */
    public isConstructor(Context isParameter, List<Favorite> isParameter, int isParameter) {
    ...
    public View isMethod(int isParameter, View isParameter, ViewGroup isParameter) {
        ...
        // isComment
        Favorite isVariable = isNameExpr.isMethod(isNameExpr);
