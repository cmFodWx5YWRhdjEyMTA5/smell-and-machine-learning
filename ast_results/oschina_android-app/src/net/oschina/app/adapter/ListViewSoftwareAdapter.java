...
public class isClassOrIsInterface extends BaseAdapter {
    ...
    // isComment
    private List<Software> isVariable;
     ...
     * isComment
     */
    public isConstructor(Context isParameter, List<Software> isParameter, int isParameter) {
    ...
    public View isMethod(int isParameter, View isParameter, ViewGroup isParameter) {
        ...
        // isComment
        Software isVariable = isNameExpr.isMethod(isNameExpr);
