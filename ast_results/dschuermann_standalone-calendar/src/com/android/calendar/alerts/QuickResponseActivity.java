 ...
 * isComment
 */
public class isClassOrIsInterface extends ListActivity implements OnItemClickListener {
    ...
    protected void isMethod(Bundle isParameter) {
        ...
        // isComment
        isMethod().isMethod(isNameExpr.this);
        // isComment
        ...
        isMethod(new ArrayAdapter<String>(this, isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr));
    }
    ...
    public void isMethod(AdapterView<?> isParameter, View isParameter, int isParameter, long isParameter) {
        ...
        // isComment
        new QueryThread(isNameExpr, isNameExpr).isMethod();
    }
    ...
    private class isClassOrIsInterface extends Thread {
        ...
        public void isMethod() {
            Intent isVariable = isNameExpr.isMethod(isNameExpr.this, isNameExpr, isNameExpr);
            if (isNameExpr != null) {
                try {
                    isMethod(isNameExpr);
                    isMethod();
                } catch (ActivityNotFoundException isParameter) {
                    isNameExpr.this.isMethod().isMethod(new Runnable() {
