...
public class isClassOrIsInterface extends ResourceCursorAdapter {
    ...
    public void isMethod(View isParameter, Context isParameter, Cursor isParameter) {
        ...
        if (isNameExpr == null) {
            ...
            isNameExpr.isFieldAccessExpr = (ColorChipView) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        }
        ...
        // isComment
        ViewGroup.LayoutParams isVariable = isNameExpr.isFieldAccessExpr.isMethod();
        if (isNameExpr) {
            isNameExpr.isFieldAccessExpr = isNameExpr;
        } else {
            isNameExpr.isFieldAccessExpr = isNameExpr;
