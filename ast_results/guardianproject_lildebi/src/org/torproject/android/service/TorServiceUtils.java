...
public class isClassOrIsInterface implements TorServiceConstants {
    ...
    public static boolean isMethod() {
        ...
        try {
            ...
            int isVariable = isNameExpr.isMethod(isNameExpr, isNameExpr, true, true);
    ...
    // isComment
    public static int isMethod(String isParameter) throws Exception {
        int isVariable = -isIntegerConstant;
    ...
    public static int isMethod(String isParameter) throws Exception {
        ...
        String isVariable = null;
        while ((isNameExpr = isNameExpr.isMethod()) != null) {
            if (isNameExpr.isMethod('isStringConstant' + isNameExpr) != -isIntegerConstant) {
    ...
    public static int isMethod(String[] isParameter, StringBuilder isParameter, boolean isParameter, boolean isParameter) throws Exception {
        isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, "isStringConstant" + isNameExpr[isIntegerConstant] + "isStringConstant" + isNameExpr);
        Process isVariable = null;
        int isVariable = -isIntegerConstant;
        if (isNameExpr)
        ...
        isNameExpr.isMethod();
        if (isNameExpr) {
            final char[] isVariable = new char[isIntegerConstant];
            // isComment
