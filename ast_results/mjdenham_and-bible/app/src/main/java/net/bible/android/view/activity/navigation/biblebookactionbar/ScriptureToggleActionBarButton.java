...
public class isClassOrIsInterface extends ToggleActionBarButton {
    ...
    private final NavigationControl isVariable;

    @Inject
    public isConstructor(NavigationControl isParameter) {
    ...
    protected boolean isMethod() {
        return isNameExpr.isMethod(true).isMethod() > isIntegerConstant;
    }
}
