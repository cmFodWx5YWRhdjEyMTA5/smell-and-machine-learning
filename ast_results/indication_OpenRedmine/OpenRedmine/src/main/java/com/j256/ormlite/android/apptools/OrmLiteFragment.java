 ...
 * isComment
 */
public abstract class isClassOrIsInterface<H extends OrmLiteSqliteOpenHelper> extends Fragment {

    private static Logger isVariable = isNameExpr.isMethod(OrmLiteBaseActivity.class);
