...
public class isClassOrIsInterface extends MarkCompletedConstruction {
     ...
     * isComment
     */
    private String isMethod(BoundingBox isParameter) {
        String isVariable = "isStringConstant";
        return isNameExpr.isMethod(isNameExpr) + "isStringConstant" + isMethod("isStringConstant", isNameExpr, isIntegerConstant) + isNameExpr + "isStringConstant" + isNameExpr.isMethod();
    }
    ...
    public int isMethod(@NonNull Map<String, String> isParameter) {
        if (isNameExpr.isMethod(isNameExpr.isFieldAccessExpr).isMethod(isNameExpr.isMethod("isStringConstant"))) {
            return isNameExpr.isFieldAccessExpr.isFieldAccessExpr;
