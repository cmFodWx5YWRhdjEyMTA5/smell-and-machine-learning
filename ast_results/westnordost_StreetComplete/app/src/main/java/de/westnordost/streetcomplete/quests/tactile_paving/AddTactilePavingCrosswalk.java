...
public class isClassOrIsInterface extends SimpleOverpassQuestType {
    ...
    static final Countries isVariable = isNameExpr.isMethod(new String[] { // isComment
    "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", "isStringConstant", // isComment
