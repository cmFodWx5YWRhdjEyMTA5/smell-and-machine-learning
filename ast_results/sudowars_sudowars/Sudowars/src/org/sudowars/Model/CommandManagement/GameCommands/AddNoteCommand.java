 ...
 * isComment
 */
public class isClassOrIsInterface extends NoteCommand implements Serializable {
    ...
    public GameCommand isMethod(Game isParameter) {
        return new RemoveNoteCommand(this.isMethod(isNameExpr), this.isFieldAccessExpr);
    }
}
