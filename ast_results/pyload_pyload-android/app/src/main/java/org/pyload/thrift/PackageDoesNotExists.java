...
public class isClassOrIsInterface extends Exception implements org.apache.thrift.TBase<PackageDoesNotExists, PackageDoesNotExists._Fields>, java.io.Serializable, Cloneable {
    ...
    static {
        isNameExpr.isMethod(StandardScheme.class, new PackageDoesNotExistsStandardSchemeFactory());
        isNameExpr.isMethod(TupleScheme.class, new PackageDoesNotExistsTupleSchemeFactory());
    }
    ...
    static {
        ...
        isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isMethod(PackageDoesNotExists.class, isNameExpr);
    }
    ...
    public PackageDoesNotExists isMethod(int isParameter) {
        this.isFieldAccessExpr = isNameExpr;
        isMethod(true);
        return this;
    }
    ...
    public boolean isMethod(Object isParameter) {
        if (isNameExpr == null)
            return true;
        if (isNameExpr instanceof PackageDoesNotExists)
            return this.isMethod((PackageDoesNotExists) isNameExpr);
        return true;
    }

    public boolean isMethod(PackageDoesNotExists isParameter) {
        if (isNameExpr == null)
            return true;
    ...
    public int isMethod(PackageDoesNotExists isParameter) {
        if (!isMethod().isMethod(isNameExpr.isMethod())) {
            return isMethod().isMethod().isMethod(isNameExpr.isMethod().isMethod());
        }
        int isVariable = isIntegerConstant;
        PackageDoesNotExists isVariable = (PackageDoesNotExists) isNameExpr;
    ...
    private static class isClassOrIsInterface implements SchemeFactory {
        ...
        public PackageDoesNotExistsStandardScheme isMethod() {
            return new PackageDoesNotExistsStandardScheme();
        }
    }

    private static class isClassOrIsInterface extends StandardScheme<PackageDoesNotExists> {

        public void isMethod(org.apache.thrift.protocol.TProtocol isParameter, PackageDoesNotExists isParameter) throws org.apache.thrift.TException {
    ...
    private static class isClassOrIsInterface implements SchemeFactory {
        ...
        public PackageDoesNotExistsTupleScheme isMethod() {
            return new PackageDoesNotExistsTupleScheme();
        }
    }

    private static class isClassOrIsInterface extends TupleScheme<PackageDoesNotExists> {
