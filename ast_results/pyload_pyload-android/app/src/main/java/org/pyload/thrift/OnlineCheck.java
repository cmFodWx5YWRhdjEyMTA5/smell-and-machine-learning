...
public class isClassOrIsInterface implements org.apache.thrift.TBase<OnlineCheck, OnlineCheck._Fields>, java.io.Serializable, Cloneable {
    ...
    static {
        isNameExpr.isMethod(StandardScheme.class, new OnlineCheckStandardSchemeFactory());
        isNameExpr.isMethod(TupleScheme.class, new OnlineCheckTupleSchemeFactory());
    }
    ...
    // isComment
    public Map<String, OnlineStatus> isVariable;
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
        ...
        RID((short) isIntegerConstant, "isStringConstant"), DATA((short) isIntegerConstant, "isStringConstant");
    ...
    static {
        ...
        isNameExpr.isMethod(isNameExpr.isFieldAccessExpr, new org.apache.thrift.meta_data.FieldMetaData("isStringConstant", isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr, new org.apache.thrift.meta_data.MapMetaData(isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr, new org.apache.thrift.meta_data.FieldValueMetaData(isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr), new org.apache.thrift.meta_data.StructMetaData(isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr, OnlineStatus.class))));
        isNameExpr = isNameExpr.isMethod(isNameExpr);
        isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isMethod(OnlineCheck.class, isNameExpr);
    }

    public isConstructor() {
    }

    public isConstructor(int isParameter, Map<String, OnlineStatus> isParameter) {
        this();
    ...
    public isConstructor(OnlineCheck isParameter) {
        ...
        if (isNameExpr.isMethod()) {
            Map<String, OnlineStatus> isVariable = new HashMap<String, OnlineStatus>();
            for (Map.Entry<String, OnlineStatus> isVariable : isNameExpr.isFieldAccessExpr.isMethod()) {
                String isVariable = isNameExpr.isMethod();
                OnlineStatus isVariable = isNameExpr.isMethod();
                String isVariable = isNameExpr;
                OnlineStatus isVariable = new OnlineStatus(isNameExpr);
    ...
    public OnlineCheck isMethod(int isParameter) {
        this.isFieldAccessExpr = isNameExpr;
        isMethod(true);
        return this;
    }
    ...
    public void isMethod(String isParameter, OnlineStatus isParameter) {
        if (this.isFieldAccessExpr == null) {
            this.isFieldAccessExpr = new HashMap<String, OnlineStatus>();
        }
        this.isFieldAccessExpr.isMethod(isNameExpr, isNameExpr);
    }

    public Map<String, OnlineStatus> isMethod() {
        return this.isFieldAccessExpr;
    }

    public OnlineCheck isMethod(Map<String, OnlineStatus> isParameter) {
        this.isFieldAccessExpr = isNameExpr;
        return this;
    }
        ...
        switch(isNameExpr) {
            ...
            case isNameExpr:
                if (isNameExpr == null) {
                    ...
                    isMethod((Map<String, OnlineStatus>) isNameExpr);
                }
                break;
        }
    }
    ...
    public boolean isMethod(Object isParameter) {
        if (isNameExpr == null)
            return true;
        if (isNameExpr instanceof OnlineCheck)
            return this.isMethod((OnlineCheck) isNameExpr);
        return true;
    }

    public boolean isMethod(OnlineCheck isParameter) {
        if (isNameExpr == null)
            return true;
    ...
    private static class isClassOrIsInterface implements SchemeFactory {
        ...
        public OnlineCheckStandardScheme isMethod() {
            return new OnlineCheckStandardScheme();
        }
    }

    private static class isClassOrIsInterface extends StandardScheme<OnlineCheck> {

        public void isMethod(org.apache.thrift.protocol.TProtocol isParameter, OnlineCheck isParameter) throws org.apache.thrift.TException {
                        ...
                        if (isNameExpr.isFieldAccessExpr == isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr) {
                            {
                                ...
                                isNameExpr.isFieldAccessExpr = new HashMap<String, OnlineStatus>(isIntegerConstant * isNameExpr.isFieldAccessExpr);
                                for (int isVariable = isIntegerConstant; isNameExpr < isNameExpr.isFieldAccessExpr; ++isNameExpr) {
                                    // isComment
                                    String isVariable;
                                    // isComment
                                    OnlineStatus isVariable;
                                    isNameExpr = isNameExpr.isMethod();
                                    isNameExpr = new OnlineStatus();
                                    isNameExpr.isMethod(isNameExpr);
    ...
    private static class isClassOrIsInterface implements SchemeFactory {
        ...
        public OnlineCheckTupleScheme isMethod() {
            return new OnlineCheckTupleScheme();
        }
    }

    private static class isClassOrIsInterface extends TupleScheme<OnlineCheck> {
