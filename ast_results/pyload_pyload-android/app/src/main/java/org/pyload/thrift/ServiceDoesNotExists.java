...
public class isClassOrIsInterface extends Exception implements org.apache.thrift.TBase<ServiceDoesNotExists, ServiceDoesNotExists._Fields>, java.io.Serializable, Cloneable {
    ...
    static {
        isNameExpr.isMethod(StandardScheme.class, new ServiceDoesNotExistsStandardSchemeFactory());
        isNameExpr.isMethod(TupleScheme.class, new ServiceDoesNotExistsTupleSchemeFactory());
    }
    ...
    static {
        ...
        isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr.isMethod(ServiceDoesNotExists.class, isNameExpr);
    }
     ...
     * isComment
     */
    public isConstructor(ServiceDoesNotExists isParameter) {
    ...
    public ServiceDoesNotExists isMethod(String isParameter) {
        this.isFieldAccessExpr = isNameExpr;
        return this;
    }
    ...
    public boolean isMethod(Object isParameter) {
        if (isNameExpr == null)
            return true;
        if (isNameExpr instanceof ServiceDoesNotExists)
            return this.isMethod((ServiceDoesNotExists) isNameExpr);
        return true;
    }

    public boolean isMethod(ServiceDoesNotExists isParameter) {
        if (isNameExpr == null)
            return true;
    ...
    public int isMethod(ServiceDoesNotExists isParameter) {
        if (!isMethod().isMethod(isNameExpr.isMethod())) {
            return isMethod().isMethod().isMethod(isNameExpr.isMethod().isMethod());
        }
        int isVariable = isIntegerConstant;
        ServiceDoesNotExists isVariable = (ServiceDoesNotExists) isNameExpr;
    ...
    private static class isClassOrIsInterface implements SchemeFactory {
        ...
        public ServiceDoesNotExistsStandardScheme isMethod() {
            return new ServiceDoesNotExistsStandardScheme();
        }
    }

    private static class isClassOrIsInterface extends StandardScheme<ServiceDoesNotExists> {

        public void isMethod(org.apache.thrift.protocol.TProtocol isParameter, ServiceDoesNotExists isParameter) throws org.apache.thrift.TException {
    ...
    private static class isClassOrIsInterface implements SchemeFactory {
        ...
        public ServiceDoesNotExistsTupleScheme isMethod() {
            return new ServiceDoesNotExistsTupleScheme();
        }
    }

    private static class isClassOrIsInterface extends TupleScheme<ServiceDoesNotExists> {
