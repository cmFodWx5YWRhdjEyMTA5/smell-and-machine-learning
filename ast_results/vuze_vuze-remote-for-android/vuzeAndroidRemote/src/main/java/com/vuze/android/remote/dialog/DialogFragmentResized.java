 ...
 * isComment
 */
public abstract class isClassOrIsInterface extends DialogFragmentBase {
    ...
    private void isMethod(Dialog isParameter) {
        try {
            if (isNameExpr) {
            ...
            int isVariable = isNameExpr.isMethod().isMethod("isStringConstant", "isStringConstant", // isComment
            "isStringConstant");
            if (isNameExpr) {
