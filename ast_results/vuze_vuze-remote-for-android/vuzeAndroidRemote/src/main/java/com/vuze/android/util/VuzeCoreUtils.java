...
public class isClassOrIsInterface {
    ...
    @Thunk
    static VuzeServiceInit isVariable = null;
    ...
    private static VuzeServiceInit isMethod() {
        Map<String, Runnable> isVariable = new HashMap<>();
        isNameExpr.isMethod("isStringConstant", new RunnableWithObject() {
            ...
            public void isMethod() {
                ...
                if (isNameExpr.isMethod("isStringConstant")) {
                    Session isVariable = isNameExpr.isMethod();
                    Activity isVariable = isNameExpr == null ? null : isNameExpr.isMethod();
        ...
        return new VuzeServiceInitImpl(isNameExpr.isMethod(), isNameExpr);
    }

    // isComment
    public static void isMethod(final Activity isParameter, int isParameter) {
