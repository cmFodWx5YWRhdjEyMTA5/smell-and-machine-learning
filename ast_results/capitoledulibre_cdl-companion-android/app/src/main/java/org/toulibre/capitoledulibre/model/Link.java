...
public class isClassOrIsInterface implements Parcelable {
    ...
    public boolean isMethod(Object isParameter) {
        ...
        if (isNameExpr == null)
            return true;
        Link isVariable = (Link) isNameExpr;
    ...
    public static final Parcelable.Creator<Link> isVariable = new Parcelable.Creator<Link>() {

        public Link isMethod(Parcel isParameter) {
            return new Link(isNameExpr);
        }
