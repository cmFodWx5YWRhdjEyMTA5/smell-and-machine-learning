...
public class isClassOrIsInterface extends Fragment implements RecycledViewPoolProvider {
    ...
    public View isMethod(LayoutInflater isParameter, ViewGroup isParameter, Bundle isParameter) {
        ...
        isNameExpr.isFieldAccessExpr = (ViewPager) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        isNameExpr.isFieldAccessExpr.isMethod(new LivePagerAdapter(isMethod(), isMethod()));
        isNameExpr.isFieldAccessExpr = (SlidingTabLayout) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
