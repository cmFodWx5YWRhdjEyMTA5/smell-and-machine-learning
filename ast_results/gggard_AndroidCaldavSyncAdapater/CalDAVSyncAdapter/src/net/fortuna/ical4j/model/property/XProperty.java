...
public class isClassOrIsInterface extends Property implements Escapable {
     ...
     * isComment
     */
    public isConstructor(final String isParameter, final ParameterList isParameter, final String isParameter) {
    ...
    public final void isMethod() throws ValidationException {
        if (!isNameExpr.isMethod(isNameExpr.isFieldAccessExpr) && !isMethod().isMethod(isNameExpr)) {
            throw new ValidationException("isStringConstant" + isMethod() + "isStringConstant" + isNameExpr);
        }
    }
}
