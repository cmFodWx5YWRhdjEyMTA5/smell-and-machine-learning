...
public class isClassOrIsInterface extends Fragment {
    ...
    public static HttpHeaderFieldManipulationFragment isMethod(Measurement isParameter) {
        Bundle isVariable = new Bundle();
        isNameExpr.isMethod(isNameExpr, isNameExpr);
        HttpHeaderFieldManipulationFragment isVariable = new HttpHeaderFieldManipulationFragment();
