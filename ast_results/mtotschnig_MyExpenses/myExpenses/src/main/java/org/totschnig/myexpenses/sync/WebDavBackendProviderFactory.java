...
public class isClassOrIsInterface extends SyncBackendProviderFactory {
    ...
    @NonNull
    @Override
    protected SyncBackendProvider isMethod(Context isParameter, Account isParameter, AccountManager isParameter) throws SyncParseException {
        return new WebDavBackendProvider(isNameExpr, isNameExpr, isNameExpr);
    }

    @Override
    public void isMethod(ProtectedFragmentActivity isParameter) {
        SetupWebdavDialogFragment isVariable = new SetupWebdavDialogFragment();
