...
public class isClassOrIsInterface extends ArrayAdapter<OrthogonalImplantation.Result> {

    public isConstructor(Context isParameter, int isParameter, ArrayList<OrthogonalImplantation.Result> isParameter) {
    ...
    public View isMethod(int isParameter, View isParameter, ViewGroup isParameter) {
        ...
        OrthogonalImplantation.Result isVariable = this.isMethod(isNameExpr);
        if (isNameExpr != null) {
