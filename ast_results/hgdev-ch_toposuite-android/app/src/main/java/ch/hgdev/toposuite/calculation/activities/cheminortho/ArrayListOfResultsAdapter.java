 ...
 * isComment
 */
public class isClassOrIsInterface extends ArrayAdapter<CheminementOrthogonal.Result> {

    public isConstructor(Context isParameter, int isParameter, ArrayList<CheminementOrthogonal.Result> isParameter) {
    ...
    public View isMethod(int isParameter, View isParameter, ViewGroup isParameter) {
        ...
        CheminementOrthogonal.Result isVariable = this.isMethod(isNameExpr);
        if (isNameExpr != null) {
