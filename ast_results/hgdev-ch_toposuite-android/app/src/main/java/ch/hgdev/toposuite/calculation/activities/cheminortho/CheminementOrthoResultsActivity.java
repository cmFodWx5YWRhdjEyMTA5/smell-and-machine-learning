...
public class isClassOrIsInterface extends TopoSuiteActivity implements MergePointsDialog.MergePointsDialogListener {
    ...
    private ArrayListOfResultsAdapter isVariable;
    ...
    protected void isMethod(Bundle isParameter) {
        ...
        if (isNameExpr != null) {
            this.isFieldAccessExpr = (CheminementOrthogonal) isNameExpr.isMethod(isNameExpr.isFieldAccessExpr);
            ...
            try {
                ...
                this.isFieldAccessExpr.isMethod(isNameExpr.isMethod(this.isFieldAccessExpr.isMethod()));
                this.isFieldAccessExpr.isMethod(isNameExpr.isMethod(isNameExpr.isMethod(this.isFieldAccessExpr.isMethod())));
                this.isFieldAccessExpr.isMethod(isNameExpr.isMethod(isNameExpr.isMethod(this.isFieldAccessExpr.isMethod())));
                this.isFieldAccessExpr.isMethod(isNameExpr.isMethod(isNameExpr.isMethod(this.isFieldAccessExpr.isMethod())));
                this.isMethod(this.isFieldAccessExpr);
                this.isMethod();
                this.isFieldAccessExpr = this.isFieldAccessExpr.isMethod().isMethod() - isIntegerConstant;
    ...
    private void isMethod() {
        this.isFieldAccessExpr = new ArrayListOfResultsAdapter(this, isNameExpr.isFieldAccessExpr.isFieldAccessExpr, this.isFieldAccessExpr.isMethod());
    ...
    private void isMethod() {
        ...
        // isComment
        for (int isVariable = isIntegerConstant; isNameExpr < (this.isFieldAccessExpr.isMethod() - isIntegerConstant); isNameExpr++) {
    ...
    private boolean isMethod(int isParameter) {
        Result isVariable = this.isFieldAccessExpr.isMethod(isNameExpr);
        if (isNameExpr.isMethod().isMethod(isNameExpr.isMethod()) == null) {
            Point isVariable = new Point(isNameExpr.isMethod(), isNameExpr.isMethod(), isNameExpr.isMethod(), isNameExpr.isFieldAccessExpr, true);
            isNameExpr.isMethod().isMethod(isNameExpr);
            return true;
        } else {
            // isComment
            ++this.isFieldAccessExpr;
            MergePointsDialog isVariable = new MergePointsDialog();
