...
public class isClassOrIsInterface {
    ...
    public void isMethod() {
        ContentValues isVariable = new DueDated(isMethod(), ContentValues::new).isMethod();
    ...
    public void isMethod() {
        ...
        ContentValues isVariable = new DueDated(new Present<>(isNameExpr), ContentValues::new).isMethod();
