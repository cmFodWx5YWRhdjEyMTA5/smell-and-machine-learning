...
public class isClassOrIsInterface extends BaseHtmlTest {
    ...
    public void isMethod() throws OpacApi.OpacErrorException {
        ...
        if (isNameExpr == null)
            return;
        List<LentItem> isVariable = isNameExpr.isMethod(isNameExpr.isMethod(isNameExpr), new DummyStringProvider());
    ...
    public void isMethod() throws OpacApi.OpacErrorException {
        ...
        if (isNameExpr == null)
            return;
        List<ReservedItem> isVariable = isNameExpr.isMethod(isNameExpr.isMethod(isNameExpr), new DummyStringProvider());
        isMethod(isNameExpr.isMethod() > isIntegerConstant);
    }
}
