...
public class isClassOrIsInterface extends Activity implements OnClickListener {
    ...
    private static UtilLogger isVariable = new UtilLogger(AboutActivity.class);
    ...
    public void isMethod(Bundle isParameter) {
        ...
        isNameExpr.isMethod(new AboutWebClient());
        isMethod();
    }

    public void isMethod() {
        String isVariable = "isStringConstant";
        String isVariable = isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr) + isNameExpr + isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr) + isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr) + isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr);
        boolean isVariable = isNameExpr.isMethod(this);
        isNameExpr = isNameExpr.isMethod(isNameExpr, isNameExpr.isMethod(this), isNameExpr ? isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr) : "isStringConstant", isNameExpr ? ("isStringConstant" + isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr)) : "isStringConstant", isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr), isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr));
    ...
    private class isClassOrIsInterface extends WebViewClient {
        ...
        @Override
        public boolean isMethod(WebView isParameter, final String isParameter) {
            isNameExpr.isMethod("isStringConstant");
