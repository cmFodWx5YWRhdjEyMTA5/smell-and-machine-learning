...
public class isClassOrIsInterface extends BothWaySwipeRefreshLayout implements PhotosView, PagerView, LoadView, ScrollView, SwipeBackView, BothWaySwipeRefreshLayout.OnRefreshAndLoadListener, MiniErrorStateAdapter.OnRetryListener {
    ...
    private static class isClassOrIsInterface implements Parcelable {
        ...
        isConstructor(MePhotosView isParameter) {
    ...
    public isConstructor(MeActivity isParameter, int isParameter, int isParameter, int isParameter, boolean isParameter) {
        super(isNameExpr);
    ...
    // isComment
    @SuppressLint("isStringConstant")
    private void isMethod(MeActivity isParameter, int isParameter, int isParameter, boolean isParameter) {
    ...
    // isComment
    private void isMethod(MeActivity isParameter, int isParameter, int isParameter, boolean isParameter) {
        this.isFieldAccessExpr = new PhotosObject(isNameExpr, new PhotoAdapter(isNameExpr, new ArrayList<Photo>(isNameExpr.isFieldAccessExpr), isNameExpr, isNameExpr), isNameExpr);
