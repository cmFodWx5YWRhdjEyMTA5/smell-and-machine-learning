...
public class isClassOrIsInterface implements PhotosModel {

    private PhotoAdapter isVariable;
    ...
    public isConstructor(Context isParameter, PhotoAdapter isParameter, @PhotoTypeRule int isParameter) {
