...
public class isClassOrIsInterface extends BothWaySwipeRefreshLayout implements PhotosView, PagerView, LoadView, ScrollView, SwipeBackView, BothWaySwipeRefreshLayout.OnRefreshAndLoadListener, MiniErrorStateAdapter.OnRetryListener {
    ...
    private static class isClassOrIsInterface implements Parcelable {
        ...
        isConstructor(UserPhotosView isParameter) {
    ...
    public isConstructor(UserActivity isParameter, User isParameter, int isParameter, int isParameter, int isParameter, boolean isParameter) {
        super(isNameExpr);
        this.isMethod(isNameExpr);
        this.isMethod(isNameExpr, isNameExpr, isNameExpr, isNameExpr, isNameExpr);
    }

    // isComment
    @SuppressLint("isStringConstant")
    private void isMethod(UserActivity isParameter, User isParameter, int isParameter, int isParameter, boolean isParameter) {
    ...
    private void isMethod(UserActivity isParameter, User isParameter, int isParameter, int isParameter, boolean isParameter) {
        this.isFieldAccessExpr = new PhotosObject(isNameExpr, isNameExpr, isNameExpr);
