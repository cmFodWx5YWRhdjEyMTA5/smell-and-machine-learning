...
public class isClassOrIsInterface implements PagerPresenter {

    private PagerModel isVariable;

    private PagerView isVariable;

    public isConstructor(PagerModel isParameter, PagerView isParameter) {
