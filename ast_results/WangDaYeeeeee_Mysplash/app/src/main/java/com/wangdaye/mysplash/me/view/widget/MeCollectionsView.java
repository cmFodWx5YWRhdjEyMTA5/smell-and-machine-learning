...
public class isClassOrIsInterface extends BothWaySwipeRefreshLayout implements CollectionsView, PagerView, LoadView, ScrollView, SwipeBackView, BothWaySwipeRefreshLayout.OnRefreshAndLoadListener, MiniErrorStateAdapter.OnRetryListener {
    ...
    private static class isClassOrIsInterface implements Parcelable {
        ...
        isConstructor(MeCollectionsView isParameter) {
    ...
    public isConstructor(MeActivity isParameter, int isParameter, int isParameter, boolean isParameter) {
        super(isNameExpr);
    ...
    // isComment
    @SuppressLint("isStringConstant")
    private void isMethod(MeActivity isParameter, int isParameter, boolean isParameter) {
    ...
    private void isMethod(MeActivity isParameter, int isParameter, boolean isParameter) {
        this.isFieldAccessExpr = new CollectionsObject(isNameExpr);
