...
public class isClassOrIsInterface extends ArrayAdapter<String> {
    ...
    public isConstructor(Activity isParameter, List<String> isParameter, boolean isParameter) {
    ...
    public View isMethod(final int isParameter, View isParameter, ViewGroup isParameter) {
        ...
        OpenPgpUtils.UserId isVariable = isNameExpr.isMethod(isNameExpr.isFieldAccessExpr);
