 ...
 * isComment
 */
public class isClassOrIsInterface extends ViewAnimator {
    ...
    @Override
    public void isMethod(@NonNull View isParameter, int isParameter, ViewGroup.LayoutParams isParameter) {
