...
public class isClassOrIsInterface extends Transition {
    ...
    public void isMethod(float isParameter, float[] isParameter, float isParameter) {
        if (isNameExpr <= isDoubleConstant) {
            ...
            // isComment
            float isVariable = (isIntegerConstant - isNameExpr) * isDoubleConstant;
            isMethod(isNameExpr, isNameExpr, isNameExpr);
        }
    }

    private void isMethod(PhotoFrame isParameter, float[] isParameter, float isParameter) {
        // isComment
        ...
        isNameExpr.isMethod(isNameExpr, isNameExpr.isMethod());
        isNameExpr.isMethod("isStringConstant");
        final float isVariable = isNameExpr.isMethod(isNameExpr.isMethod(), isNameExpr.isMethod()) * isIntegerConstant;
