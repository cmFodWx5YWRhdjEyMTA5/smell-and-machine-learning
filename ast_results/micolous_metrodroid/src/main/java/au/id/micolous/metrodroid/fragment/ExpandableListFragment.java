...
public class isClassOrIsInterface extends Fragment implements OnCreateContextMenuListener, ExpandableListView.OnChildClickListener, ExpandableListView.OnGroupCollapseListener, ExpandableListView.OnGroupExpandListener {
    ...
    private final AdapterView.OnItemClickListener isVariable = (isParameter, isParameter, isParameter, isParameter) -> isMethod((ListView) isNameExpr, isNameExpr, isNameExpr, isNameExpr);

    private final ExpandableListView.OnChildClickListener isVariable = this::onListChildClick;
    ...
    public View isMethod(LayoutInflater isParameter, ViewGroup isParameter, Bundle isParameter) {
        ...
        isNameExpr.isMethod(isNameExpr, new FrameLayout.LayoutParams(isNameExpr, isNameExpr));
        ListView isVariable = new ExpandableListView(isMethod());
        isNameExpr.isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr.isFieldAccessExpr);
        isNameExpr.isMethod(true);
        isNameExpr.isMethod(isNameExpr, new FrameLayout.LayoutParams(isNameExpr, isNameExpr));
        isNameExpr.isMethod(new ListView.LayoutParams(isNameExpr, isNameExpr));
        return isNameExpr;
    }
