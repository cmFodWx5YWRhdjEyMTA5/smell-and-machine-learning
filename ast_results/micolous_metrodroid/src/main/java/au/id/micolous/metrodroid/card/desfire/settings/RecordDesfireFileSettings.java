...
public class isClassOrIsInterface extends DesfireFileSettings {
    ...
    public isConstructor(byte isParameter, byte isParameter, byte[] isParameter, int isParameter, int isParameter, int isParameter) {
    ...
    public isConstructor(ByteArrayInputStream isParameter) {
        super(isNameExpr);
