...
public class isClassOrIsInterface extends ScrollView {
    ...
    private ScrollViewListener isVariable = null;
    ...
    public void isMethod(ScrollViewListener isParameter) {
    ...
    public interface isClassOrIsInterface {
        ...
        void isMethod(ScrollViewExt isParameter, int isParameter, int isParameter, int isParameter, int isParameter);
    }
}
