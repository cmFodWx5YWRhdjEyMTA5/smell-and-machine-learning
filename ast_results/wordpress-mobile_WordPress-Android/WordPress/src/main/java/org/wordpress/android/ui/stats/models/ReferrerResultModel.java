...
public class isClassOrIsInterface implements Serializable {
    ...
    private List<SingleItemModel> isVariable;

    public isConstructor(long isParameter, String isParameter, JSONObject isParameter) throws JSONException {
        isMethod(isNameExpr);
        ...
        if (isNameExpr.isMethod("isStringConstant")) {
            ...
            // isComment
            isNameExpr.isMethod(isNameExpr, new java.util.Comparator<SingleItemModel>() {

                public int isMethod(SingleItemModel isParameter, SingleItemModel isParameter) {
                    // isComment
    ...
    private SingleItemModel isMethod(long isParameter, String isParameter, JSONObject isParameter) throws JSONException {
        ...
        String isVariable = isNameExpr.isMethod("isStringConstant");
        return new SingleItemModel(isNameExpr, isNameExpr, null, isNameExpr, isNameExpr, isNameExpr, isNameExpr);
    }
    ...
    public List<SingleItemModel> isMethod() {
        return isNameExpr;
    }
}
