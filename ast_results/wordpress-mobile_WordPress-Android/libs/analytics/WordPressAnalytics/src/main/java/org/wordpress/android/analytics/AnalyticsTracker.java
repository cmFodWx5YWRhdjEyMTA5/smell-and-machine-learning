...
public final class isClassOrIsInterface {
    ...
    public enum Stat {
        ...
        EDITOR_EDITED_IMAGE,
        // isComment
        EDITOR_HYBRID_ENABLED,
        // isComment
        EDITOR_HYBRID_TOGGLED_OFF,
        // isComment
        EDITOR_HYBRID_TOGGLED_ON,
        // isComment
        ...
        // isComment
        EDITOR_TAPPED_LINK_REMOVED,
        EDITOR_TAPPED_LIST,
        // isComment
        EDITOR_TAPPED_LIST_ORDERED,
        // isComment
        EDITOR_TAPPED_LIST_UNORDERED,
        ...
        QUICK_START_LIST_SKIP_ALL_TAPPED,
        QUICK_START_LIST_COMPLETED_VIEWED,
    ...
    private static final List<Tracker> isVariable = new ArrayList<>();
    ...
    public static void isMethod(Tracker isParameter) {
        if (isNameExpr != null) {
            isNameExpr.isMethod(isNameExpr);
        }
    }

    public static void isMethod(Stat isParameter) {
        if (isNameExpr) {
            return;
        }
        for (Tracker isVariable : isNameExpr) {
            isNameExpr.isMethod(isNameExpr);
        }
    }

    public static void isMethod(Stat isParameter, Map<String, ?> isParameter) {
        if (isNameExpr) {
            return;
        }
        for (Tracker isVariable : isNameExpr) {
     ...
     * isComment
     */
    public static void isMethod(Stat isParameter, String isParameter, String isParameter, String isParameter) {
    ...
    public static void isMethod(AnalyticsMetadata isParameter) {
        for (Tracker isVariable : isNameExpr) {
            isNameExpr.isMethod(isNameExpr);
        }
    }
