...
public class isClassOrIsInterface {
    ...
    public static JsonNode isMethod(String isParameter) {
        ...
        try {
            ...
            if (isNameExpr != null) {
                ...
                isNameExpr = isNameExpr.isMethod(isNameExpr, JsonNode.class);
                isNameExpr.isMethod();
            }
     ...
     * isComment
     */
    public static String isMethod(InputStream isParameter) {
