...
public class isClassOrIsInterface extends GroupDetailsBaseFragment {
    ...
    private GroupDetailsPeopleAdapter isVariable;
    ...
    protected void isMethod() {
        ...
        isNameExpr = new GroupDetailsPeopleAdapter(isMethod(), new GroupDetailsPeopleAdapter.OnSelectUserListener() {

            @Override
            public void isMethod(GroupUser isParameter, int isParameter) {
