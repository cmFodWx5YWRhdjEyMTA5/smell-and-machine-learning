...
public class isClassOrIsInterface extends ShaderAdapter implements SpinnerAdapter {
    ...
    public View isMethod(Context isParameter, Cursor isParameter, ViewGroup isParameter) {
        return isNameExpr.isMethod(isNameExpr.isMethod()).isMethod(isNameExpr.isFieldAccessExpr.isFieldAccessExpr, isNameExpr, true);
    }
