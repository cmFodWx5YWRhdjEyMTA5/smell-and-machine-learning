 ...
 * isComment
 */
public class isClassOrIsInterface extends SSLSocketFactory {

    private SSLSocketFactory isVariable;

    public isConstructor() throws KeyManagementException, NoSuchAlgorithmException {
    ...
    @Override
    public Socket isMethod(String isParameter, int isParameter) throws IOException, UnknownHostException {
        return isMethod(isNameExpr.isMethod(isNameExpr, isNameExpr));
    }

    @Override
    public Socket isMethod(String isParameter, int isParameter, InetAddress isParameter, int isParameter) throws IOException, UnknownHostException {
        return isMethod(isNameExpr.isMethod(isNameExpr, isNameExpr, isNameExpr, isNameExpr));
    }
    ...
    private Socket isMethod(Socket isParameter) {
        if (isNameExpr != null && (isNameExpr instanceof SSLSocket)) {
            ((SSLSocket) isNameExpr).isMethod(new String[] { "isStringConstant", "isStringConstant", "isStringConstant" });
        }
        return isNameExpr;
    }
}
