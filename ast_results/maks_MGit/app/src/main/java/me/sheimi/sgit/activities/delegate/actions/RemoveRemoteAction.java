...
public class isClassOrIsInterface extends RepoAction {
    ...
    public void isMethod() {
        ...
        RemoveRemoteDialog isVariable = new RemoveRemoteDialog();
        isNameExpr.isMethod(isNameExpr.isMethod());
        isNameExpr.isMethod(isNameExpr.isMethod(), "isStringConstant");
        isNameExpr.isMethod();
    }

    public static void isMethod(Repo isParameter, RepoDetailActivity isParameter, String isParameter) throws IOException {
