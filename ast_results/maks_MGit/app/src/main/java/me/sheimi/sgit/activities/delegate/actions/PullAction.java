...
public class isClassOrIsInterface extends RepoAction {
    ...
    public void isMethod() {
        ...
        PullDialog isVariable = new PullDialog();
        isNameExpr.isMethod(isNameExpr.isMethod());
        isNameExpr.isMethod(isNameExpr.isMethod(), "isStringConstant");
        isNameExpr.isMethod();
    }

    private static void isMethod(Repo isParameter, RepoDetailActivity isParameter, String isParameter, boolean isParameter) {
        PullTask isVariable = new PullTask(isNameExpr, isNameExpr, isNameExpr, isNameExpr.new ProgressCallback(isNameExpr.isFieldAccessExpr.isFieldAccessExpr));
        isNameExpr.isMethod();
        isNameExpr.isMethod();
    }
